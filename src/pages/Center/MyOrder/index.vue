    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="order in myOrderInfo" :key="order.id">
                    <thead>
                        <tr>
                            <th colspan="5">
                    ...
                    <tbody>
                        <tr v-for="(orderDetail, index) in order.orderDetailList" :key="orderDetail.id">
                            <template v-if="index === 0">
                                ...
                                <!-- 按商品数合并单元格，只留一个td的单元格 -->
                                <td :rowspan="orderDetail.length" width="8%" class="center">{{ order.consignee }}</td>
...
export default {
    ...
    methods: {
        async getMyOrderInfo() {
            ...
            if (result.code === 200) {
                this.myOrderInfo = result.data.records
